...
<<<<<<< HEAD
`CausalInvestData` provides realistic datasets to help researchers and analysts test causal inference methods such as matching, propensity score weighting, causal forests, and time-series modeling in a financial context.
...
Pull requests and bug reports are welcome at [https://github.com/edzai/CausalInvestData](https://github.com/edzai/CausalInvestData)
=======
## 📁 Available Datasets
