...
We’ll explore this using the `fund_performance` dataset.
...
Let’s inspect how treatment effects differ by levels of `beta` (a proxy for fund risk exposure):
...
## 📈 Visualize Treatment Effects by Risk Exposure
...
## 🌲 Optional: Use Causal Forests (`grf`)
