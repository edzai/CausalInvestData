...
We’ll simulate an intervention (e.g. policy shock) occurring at time point 80.

---

## 🧪 Create Pre/Post-Intervention Periods
...
## 🧾 Optional: Use `CausalImpact` Package
